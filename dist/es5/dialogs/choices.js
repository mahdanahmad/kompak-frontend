...
app.controller('ModalChoicesController', ['$scope', function ($scope) {
	...
	$scope.inputs = [{ label: 'question', model: 'question_text', tag: 'textarea', required: true }, { label: 'answer 1', model: 'response_1', tag: 'textarea', required: true }, { label: 'answer 2', model: 'response_2', tag: 'textarea', required: true }, { label: 'answer 3', model: 'response_3', tag: 'textarea', required: true }, { label: 'answer 4', model: 'response_4', tag: 'textarea', required: true }, { label: 'correct answer', model: 'correct_response', tag: 'select', value: _.chain(4).times(function (o) {
			return o + 1;
		}).map(function (o) {
			return { id: o, name: o };
